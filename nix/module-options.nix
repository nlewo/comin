                ...
                type = lib.types.submodule {
                  options = {
                    baseUrl = lib.mkOption {
                      type = lib.types.str;
                      default = "";
                      description = "Base URL for Garnix executor";
                    };
                    cacheUrl = lib.mkOption {
                      type = lib.types.str;
                      default = "";
                      description = "Cache URL for Garnix executor";
                    };
                    retry_interval = lib.mkOption {
                      type = lib.types.int;
                      default = 0;
                      description = "Retry interval for Garnix executor";
                    };
                    cache_size = lib.mkOption {
                      type = lib.types.int;
                      default = 0;
                      description = "Cache size for Garnix executor";
                    };
                  };
                };
                default = { };
                description = "Configuration for Garnix executor";
              };
            };
          };
          default = { };
