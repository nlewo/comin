...
func (s *Store) NewDeployment(g *protobuf.Generation, operation, reason, bootedStorepath, currentStorepath string) *protobuf.Deployment {
	...
	computedOperation, computedOperationreason := computeOperation(operation, currentInhibitors, newInhibitors)
	...
	d := &protobuf.Deployment{
		...
		Generation:              g,
		Operation:               operation,
		OperationComputed:       computedOperation,
		OperationComputedReason: computedOperationreason,
		Reason:                  reason,
