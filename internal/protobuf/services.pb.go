...
type Deployment struct {
	...
	OperationComputed       string                 `protobuf:"bytes,12,opt,name=operation_computed,json=operationComputed" json:"operation_computed,omitempty"`
	OperationComputedReason string                 `protobuf:"bytes,15,opt,name=operation_computed_reason,json=operationComputedReason" json:"operation_computed_reason,omitempty"`
...
func (x *Deployment) GetOperationComputed() string {
	if x != nil {
		return x.OperationComputed
	}
	return ""
}

func (x *Deployment) GetOperationComputedReason() string {
	if x != nil {
		return x.OperationComputedReason
	}
	return ""
}
...
const file_internal_protobuf_services_proto_rawDesc = "" +
	...
	"\tbuild_err\x18\x17 \x01(\tR\bbuildErr\"\xf1\x06\n" +
	"\n" +
	"Deployment\x12\x12\n" +
	...
	"\x12operation_computed\x18\f \x01(\tR\x11operationComputed\x12:\n" +
	"\x19operation_computed_reason\x18\x0f \x01(\tR\x17operationComputedReason\x12\x1c\n" +
